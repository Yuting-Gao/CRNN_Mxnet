...
def init_args():
    ...
    parser.add_argument('--save_prefix', type=str, help='Model prefix you saved')
    parser.add_argument('--load_prefix', type=str, help='Load model prefix')
    parser.add_argument('--epoch', type=int, help='Resume model epoch')
